...
const webpackPlugins = [new webpack.IgnorePlugin(/^\.\/locale$/, /moment$/), new WebpackNotifierPlugin()]
...
gulp.task('fonts', () => gulp.src(paths.fontInput)
  .pipe(newer(paths.fontOutput))
  .pipe(gulp.dest(paths.fontOutput))
  .pipe(livereload()))

gulp.task('images', () => gulp.src(paths.imageInput)
  .pipe(newer(paths.imageOutput))
  .pipe(imagemin())
  .pipe(gulp.dest(paths.imageOutput))
  .pipe(livereload()))

gulp.task('scripts', () => gulp.src(paths.appInput)
  .pipe(named())
  .pipe(gwebpack(webpackConfig))
  .pipe(gulp.dest(paths.jsOutput))
  .pipe(livereload()))

gulp.task('styles', () => gulp.src(paths.sassInput)
