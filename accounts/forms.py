...
class BetterReadOnlyPasswordHashWidget(ReadOnlyPasswordHashWidget):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        final_attrs = forms.utils.flatatt(self.build_attrs(attrs or {}))
...
class FriendlyPasswordResetForm(OldPasswordResetForm):
    ...
    error_messages["unknown"] = "This email address doesn't have an associated user account. Are you sure you've registered?"
